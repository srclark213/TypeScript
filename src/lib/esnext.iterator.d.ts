...
declare global {
    ...
    interface IteratorObject<T, TReturn, TNext> {
         ...
         */
        reduce(callbackfn: (accumulator: T, currentValue: T, currentIndex: number) => T): T;
        reduce(callbackfn: (accumulator: T, currentValue: T, currentIndex: number) => T, initialValue: T): T;
